...
{
  "dependencies": {
    "@myapp/core": "workspace:*", // Latest in workspace
    "@myapp/utils": "workspace:^1.0.0" // Version constraint
  }
}
```
...
├── package.json       # name: "@myapp/my-package"
...
├── package.json       # name: "@myapp/my-app"
└── tsconfig.json
```
